...
age--sex specific rates for the whole of England to the age--sex population profile of each of the areas.  In order to perform empirical Bayes smoothing, we will use the {\tt eBayes} function in the {\tt SpatialEpi} package. 
...
### Empirical Bayes estimate using {\tt SpatialEpi}
