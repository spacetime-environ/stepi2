...
This example uses the [englandlocalauthority.shp](https://github.com/spacetime-environ/stepi2/blob/main/data/englandlocalauthority.shp), [copdmortalityobserved.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/copdmortalityobserved.csv), and
[copdmortalityexpected.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/copdmortalityexpected.csv) datasets from Chapter 6. 
...
rstan::traceplot(Ex9_1Stan, pars = c("a"))
...
Load the necessary libraries and the COPD data:  [englandlocalauthority.shp](https://github.com/spacetime-environ/stepi2/blob/main/data/englandlocalauthority.shp), [copdmortalityobserved.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/copdmortalityobserved.csv), and [copdmortalityexpected.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/copdmortalityexpected.csv) datasets from Chapter 6. 
...
```{r Ex 9.6 nimble clean, include = FALSE, eval = FALSE}
rm(list=ls())
```


```{r Ex 9.6 nimble load, message=FALSE, warning=FALSE, message= FALSE, eval = FALSE}
...
```{r Ex 9.6 nimble munge functions, echo = TRUE, eval = FALSE}
...
```{r Ex 9.6 nimble neighborhood, eval = FALSE}
...
```{r Ex 9.6 nimble leroux model, warning=FALSE, message = FALSE, results='hide', eval = FALSE}
...
```{r Ex 9.6 WAIC, ESS and traceplots, eval = FALSE }
...
```{r Ex 9.6 nimble leroux summary, echo = TRUE, eval = FALSE}
...
```{r Ex 9.6 plot map nimble, eval = FALSE}
...
```{r Ex 9.6 stan clean, include = FALSE, eval = FALSE}
rm(list=ls())
```


```{r Ex 9.6 stan load, message=FALSE, echo = FALSE, warning=FALSE, message= FALSE, eval = FALSE}
...
```{r Ex 9.6 stan munge functions, echo = TRUE, eval = FALSE}
...
```{r Ex 9.6 stan car effects, warning=FALSE, results='hide', message = FALSE, eval = FALSE}
...
```{r Ex 9.6 stan CAR traceplots, eval = FALSE}
#computing WAIC using the package loo
...
```{r Ex 9.6 stan CAR results, echo = TRUE, eval = FALSE}
...
```{r Ex 9.6 plot map stan, eval = FALSE}
