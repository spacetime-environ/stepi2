...
This example uses the [BlackSmokePrefData.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/BlackSmokePrefData.csv) file. 

```{r data clean and standardize}
...
```{r model, results = 'hide', message = FALSE, cache = TRUE}
