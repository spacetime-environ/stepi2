...
- [englandlocalauthority.shp](https://github.com/spacetime-environ/stepi2/blob/main/data/englandlocalauthority.shp) and [englandlocalauthority.dbf](https://github.com/spacetime-environ/stepi2/blob/main/data/englandlocalauthority.dbf) contain the location, shape, and attributes of English local authorities. The function `read_sf()` from the `sf` package  will read these shapefiles into `R`.
- [copdmortalityobserved.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/copdmortalityobserved.csv) contains the **observed**  number of hospital admissions in England by local authority. You can find this data by clicking.
- [copdmortalityexpected.csv](https://github.com/spacetime-environ/stepi2/blob/main/data/copdmortalityexpected.csv) contains the **expected** number of hospital admissions in England by local authority. 
